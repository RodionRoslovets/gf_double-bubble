...
$(document).ready(function() {
    ...
    $('.villas-slider-main').owlCarousel({
        ...
        onDragged:()=>{
            let elem = $('.villas-slider-main .owl-stage');

            let elemWidth = elem[0].offsetWidth,
                elemCount = document.querySelectorAll('.villas-slider-main .owl-item').length,
                elemOffset = [];

            for(let i = 13; i<elem[0].style.transform.split('').length; i++){

                if( !isNaN( Number( elem[0].style.transform.split('')[i] ) ) ){

                    elemOffset.push( Number( elem[0].style.transform.split('')[i] ) );

                } else if( elem[0].style.transform.split('')[i] === 'p' ) {
            ...
            elemOffset = elemOffset.join('');

            countElem = Math.round(elemOffset / (elemWidth / elemCount) + 3);

            countElem = countElem < 10 ? `0${countElem}` : countElem;

            $('.villas span.count-block__current').text(countElem);
        },
        responsive:{
            0:{
                items:1.3,
    ...
    $(".villas-arrow-right-btn").on("click", function(e){
        ...
        let villasCurrSlide = +$('.villas span.count-block__current').text();
    ...
    $('.tours-slider-main').owlCarousel({
        ...
        responsiveBaseElement:"body",
        onDragged:()=>{
            let elem = $('.tours-slider-main .owl-stage');

            let elemWidth = elem[0].offsetWidth,
                elemCount = document.querySelectorAll('.tours-slider-main .owl-item').length,
                elemOffset = [];
            ...
            $('.tours span.count-block__current').text(countElem);
        },
        responsive:{
            0:{
                items:1.3,
    ...
    $(".arrow-right-btn-tours").on("click", function(e){
        ...
        let toursCurrSlide = +$('.tours span.count-block__current').text();
    ...
    $('.clubs-slider-main').owlCarousel({
        ...
        responsiveBaseElement:"body",
        onDragged:()=>{
            let elem = $('.clubs-slider-main .owl-stage');

            let elemWidth = elem[0].offsetWidth,
                elemCount = document.querySelectorAll('.clubs-slider-main .owl-item').length,
                elemOffset = [];
            ...
            $('.clubs span.count-block__current').text(countElem);
        },
        responsive:{
            0:{
                items:1.3,
    ...
    $(".arrow-right-btn-clubs").on("click", function(e){
        ...
        let clubsCurrSlide = +$('.clubs span.count-block__current').text();
    ...
    $('.restaurants-slider-main').owlCarousel({
        ...
        responsiveBaseElement:"body",
        onDragged:()=>{
            let elem = $('.restaurants-slider-main .owl-stage');

            let elemWidth = elem[0].offsetWidth,
                elemCount = document.querySelectorAll('.restaurants-slider-main .owl-item').length,
                elemOffset = [];
            ...
            $('.restaurants span.count-block__current').text(countElem);
        },
        responsive:{
            0:{
                items:1.3,
    ...
    $(".arrow-right-btn-restaurants").on("click", function(e){
        ...
        let restaurantsCurrSlide = +$('.restaurants span.count-block__current').text();
    ...
    $('.events-slider').owlCarousel({
        ...
        responsiveBaseElement:"body",
        onDragged:()=>{
            let elem = $('.events-slider .owl-stage');

            let elemWidth = elem[0].offsetWidth,
                elemCount = document.querySelectorAll('.events-slider .owl-item').length,
                elemOffset = [];
            ...
            $('.events span.count-block__current').text(countElem);
        },
        responsive:{
            0:{
                items:1.3,
    ...
    $(".arrow-right-btn").on("click", function(e){
        ...
        let eventsCurrSlide = +$('.events span.count-block__current').text();
...
//Filter
    ...
    $('.call-contact-owner, .book-btn').click(function (e) {
        e.preventDefault();
