...
//			get_template_part( 'template-parts/content', get_post_type() );
                            ...
                            <div class="villas-slider" data-nav="thumbs" data-autoplay="true">
                                <?php foreach ($images as $image): ?>
                                    <a href="<?php echo esc_url($image['url']); ?>"><img
                                                src="<?php echo esc_url($image['url']); ?>"></a>
                                <?php endforeach; ?>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="villa-top-page__info mobile-visible">
                            <div class="villa-top-page__info-block">
                                ...
                                <div class="villa-top-page__info-address">
                                    <p><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/mark.svg"
                                            alt=""></p>
                                    <ul>
                                ...
                                <?php if ($villa_data['phone']): ?>
                                    <div class="villa-top-page__phone">
                                        ...
                                        <!-- <img
                                                    src="<?php //echo get_template_directory_uri(); ?>/assets/img/icons/tel.svg"
                                ...
                                <div class="villa-top-page__social-list">
                                    <ul><?php if ($villa_data['whatsapp']): ?>
                                        ...
                                        <?php if ($villa_data['viber']): ?>
                                            <li><a href="<?php echo $villa_data['viber'] ?>" target="_blank"><img
                                                            src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/viber.svg"
                                                            alt=""></a></li>
                                        <?php endif; ?>
                                        <?php if ($villa_data['facebook']): ?>
                                            <li><a href="<?php echo $villa_data['facebook'] ?>" target="_blank"><img
                                                            src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/facebook.svg"
                                                            alt=""></a></li>
                                        <?php endif; ?>
                                        <?php if ($villa_data['instagram']): ?>
                                            <li><a href="<?php echo $villa_data['instagram'] ?>" target="_blank"><img
    ...
    <section class="panorama-slider2">
        <div class="container">
            <div class="row">
                <?php the_field('villa_night_tour'); ?>
            </div>
        </div>
