                ...
                <div class="block-title-page">
                    ...
                    <div class="filter-grid-events">
                        <form action="" class="events-form" method="POST">
                            <p>filter: </p>
                            <select class="filter-grid-events__district" name="grid-district" style="width: 75px;">
                ...
                <?php if (have_posts()) : ?>
                    ...
                    ?>
                        ...
                        <div class="event-grid-item">
                            ...
                            <!--                                <a class="like-btn" href="#"><img src="--><?php //echo get_template_directory_uri(); 
                                                                                                            ?>
                            <!--/assets/img/icons/blue-heart.svg" alt=""></a>-->
